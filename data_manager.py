        ...
        solar_df = pd.DataFrame([
            {
                ...
                'Cell Capacity (GW)': p.cell_capacity,
                'Module Capacity (GW)': p.module_capacity,
                'Integration Capacity (GW)': p.integration_capacity,
                'Status': p.status,
                'Land Acquisition': p.land_acquisition,
                'Power Approval': p.power_approval,
                'Environment Clearance': p.environment_clearance,
                'ALMM Listing': p.almm_listing,
                'Investment (USD Million)': p.investment_usd,
                'Investment (INR Billion)': p.investment_inr,
                'Expected Completion': p.expected_completion,
        ...
        battery_df = pd.DataFrame([
            {
                ...
                'Input': p.input_type,
                'Output': p.output_type,
                'Cell Capacity (GWh)': p.cell_capacity,
                'Module Capacity (GWh)': p.module_capacity,
                'Integration Capacity (GWh)': p.integration_capacity,
                'Status': p.status,
                'Land Acquisition': p.land_acquisition,
                'Power Approval': p.power_approval,
                'Environment Clearance': p.environment_clearance,
